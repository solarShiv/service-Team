            ...
            <div className=" flex flex-col">
                <div>
                    ...
                    <div className="grid gap-3 m-6 md:grid-cols-4">
                        ...
                        <div>
                            {saralId && <button type="button" onClick={isExistSaralId} class="text-white mt-7 bg-yellow-500 ml-6 hover:bg-yellow-400 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center">Find</button>}
                        </div>
                ...
                {farmerDetails && Object.keys(farmerDetails).length > 0 ? (
                    ...
                    <div className="grid gap-3 m-6 md:grid-cols-4">
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Complainant Name<span className='text-red-500 fixed h-3'>*</span></label>
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contact Number<span className='text-red-500 fixed h-3'>*</span></label>
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address (If change)</label>
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PIN CODE</label>
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">AUTHORITY<span className='text-red-500 fixed h-3'>*</span></label>
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Choose Company Name<span className='text-red-500 fixed h-3'>*</span></label>
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Complaint Details<span className='text-red-500 fixed h-3'>*</span></label>
