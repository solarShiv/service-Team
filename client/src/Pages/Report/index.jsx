...
import { downloadReport } from '../../Utils/APIs/downloadExcelAPI';
...
const Index = () => {
  ...
  const onClickDownloadExcel = () => {
    const params = { stageId: selectedStage,  assignEmployee: selectedEmployee, startDate, endDate}
  ...
  return (
    <div className="grid gap-3 m-6 md:grid-cols-5 items-center">
      ...
      <div>
        <label for="startDate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date<span className='text-red-500 fixed h-3'>*</span></label>
      ...
      <div>
        <label for="endDate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date<span className='text-red-500 fixed h-3'>*</span></label>
      ...
      <div>
        ...
        <button onClick={onClickDownloadExcel} type="button" className=" text-gray-900 text-sm rounded-sm block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600  bg-yellow-300 hover:bg-yellow-500 font-medium">Download</button>
      </div>
    </div>
