              ...
              <div className="formField">
                  <form onSubmit={farmerRegister}>
                      <div class="grid gap-3 m-6 md:grid-cols-4">
                          ...
                          <div>
                              <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Farmer name<span className='text-red-500 fixed h-3'>*</span></label>
                          ...
                          <div>
                              <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Father name<span className='text-red-500 fixed h-3'>*</span></label>
                          ...
                          <div>
                              <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contact number<span className='text-red-500 fixed h-3'>*</span></label>
                          ...
                          <div>
                              <label for="state" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">State<span className='text-red-500 fixed h-3'>*</span></label>
                              <StateSelect value={selectedState} onChange={handleStateChange} />
                          </div>
                          <div>
                              <label for="state" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">District<span className='text-red-500 fixed h-3'>*</span></label>
                              <DistrictSelect  districtListData={districtList} value={district} onChange={handleDistrictChange} />
                          </div>
                          <div>
                              <label for="department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Department<span className='text-red-500 fixed h-3'>*</span></label>
                              <DepartmentSelect  departmentListData={departmentList} value={department} onChange={handleDepartmentChange} />
                          </div>
                          <div>
                              <label for="department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product<span className='text-red-500 fixed h-3'>*</span></label>
                              <ProductSelect  productListData={productList} value={product} onChange={handleProductChange} />
                          </div>
                          <div>
                              <label for="department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Project<span className='text-red-500 fixed h-3'>*</span></label>
                              {/* <ProjectSelect  departmentListData={departmentList} value={department} onChange={handleDepartmentChange} /> */}
                          </div>
                          <div>
                              <label for="block" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Block<span className='text-red-500 fixed h-3'>*</span></label>
                          ...
                          <div>
                              <label for="gram" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gram Panchayat</label>
                          ...
                          <div>
                              <label for="village" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Village</label>
                          ...
                          <div>
                              <label for="pinCode" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pin Code<span className='text-red-500 fixed h-3'>*</span></label>
                          ...
                          <div>
                              <label for="InstallationDate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Installation Date</label>
                          ...
                          <div>
                              <label for="UID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">UID No.<span className='text-red-500 fixed h-3'>*</span></label>
                              <input type="text" id="UID" onChange={(e)=>{setUID(e.target.value)}} value={UID} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123456" required />
                          </div>
                      </div>
                      <button type="submit" class="text-dark bg-yellow-500 ml-6 hover:bg-yellow-400 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
                  </form>
              </div>
      </div>
